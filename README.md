...
6. ![Screenshot](accelpic.PNG)
7. ![Screenshot](brakepic.PNG)
8. *(Optional)* Open the IVI and Cluster scenes in UnityTechnologies -> HMITemplate -> Scenes. Once opened, go into File -> Build Profile and add them to the scene list.
9. Click play to begin the demo scene.
